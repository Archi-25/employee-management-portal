/**
 * Renders docs/simple-guide.html to docs/SIMPLE-GUIDE.pdf.
...
const html = resolve('docs/simple-guide.html');
const pdf = resolve('docs/SIMPLE-GUIDE.pdf');
...
await page.pdf({
  ...
  footerTemplate:
    ...
    '<span>Employee Management Portal — The Simple Guide</span>' +
